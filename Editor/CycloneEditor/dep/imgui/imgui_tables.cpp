...
void ImGui::TableSetupColumn(const char* label, ImGuiTableColumnFlags flags, float init_width_or_weight, ImGuiID user_id)
{
    ...
    if (table->IsInitializing)
    {
        // CreateInstance width or weight
        ...
        // CreateInstance default visibility/sort state
...
//-------------------------------------------------------------------------
// [CreateInstance] 1: TableSettingsHandler_ReadXXXX()   Load and parse .ini file into TableSettings.
