...
namespace CycloneEngine
{
    ...
    public:
        CYCLONE_DLL Input();
        CYCLONE_DLL bool KeyPressed(Keycode _code) const;
        CYCLONE_DLL bool KeyUp(Keycode _code) const;
        CYCLONE_DLL bool KeyDown(Keycode _code) const;
    ...
    CYCLONE_DLL extern Input* input;
}
